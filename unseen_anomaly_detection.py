...
def run_unseen_anomaly_detection(args):
    test_list = ['backdoor', 'DoS', 'Fuzzers', 'Reconnaissance']
    train_list = ['backdoor', 'DoS', 'Fuzzers', 'Reconnaissance', 'Reconnaissance_DoS_Fuzzers', 'DoS_backdoor_Fuzzers',
                  'Reconnaissance_backdoor_Fuzzers', \
    ...
    for nm in test_list:
        for nm2 in train_list:
            ...
            writeResults(test_name + '_' + str(network_depth), x.shape[0], x.shape[1], network_depth, mean_auc, mean_aucpr, std_auc, std_aucpr, path=args.output)
...
parser.add_argument("--output", type=str,
                    default='./results/unseen_CAPL' + '.csv',
